...
public class CircularSinglyLinkedListTest extends ListTest {
    ...
    public void testConstructorWithCollection() {
        ...
        var list2 = new CircularSinglyLinkedList<>(list1);
        list2.add(0);
        list2.add(1);
        list2.add(2);
        list2.add(3);
    ...
    public void shouldThrowNullPointerExceptionWhenPassingNullToConstructorWithCollection() {
        assertThrows(NullPointerException.class, () -> new CircularSinglyLinkedList<>(null));
    }
