...
public class CircularDoublyLinkedListTest extends ListTest {
    ...
    public void testConstructorWithCollection() {
        ...
        var list2 = new CircularDoublyLinkedList<>(list1);
        list2.add(0);
        list2.add(1);
        list2.add(2);
        list2.add(3);
    ...
    public void shouldThrowNullPointerExceptionWhenPassingNullToConstructorWithCollection() {
        assertThrows(NullPointerException.class, () -> new CircularDoublyLinkedList<>(null));
    }
